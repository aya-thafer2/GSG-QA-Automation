...
class employeePersonalInfo{
    ...
    elements={
        ...
        jobTitle:()=>cy.get(':nth-child(2) > .oxd-input-group > :nth-child(2) > .oxd-select-wrapper > .oxd-select-text > .oxd-select-text--after > .oxd-icon'),
        selectJobTitle:()=>cy.get('.oxd-select-dropdown > :nth-child(2) > span'),
        employmentStatus:()=>cy.get(':nth-child(7) > .oxd-input-group > :nth-child(2) > .oxd-select-wrapper > .oxd-select-text > .oxd-select-text--after > .oxd-icon'),
        selectEmploymentStatus:()=>cy.get('.oxd-select-dropdown > :nth-child(2)'),
        subUnit:()=>cy.get(':nth-child(5) > .oxd-input-group > :nth-child(2) > .oxd-select-wrapper > .oxd-select-text > .oxd-select-text--after > .oxd-icon'),
        selectSubUnit:()=>cy.get('.oxd-select-dropdown > :nth-child(2)'),
        jobSaveBtn:()=>cy.get('.oxd-form-actions > .oxd-button'),
        reportTo:()=>cy.get(':nth-child(9) > .orangehrm-tabs-item'),
        addSupervisor:()=>cy.get(':nth-child(2) > :nth-child(1) > .orangehrm-action-header > .oxd-button'),
        supervisorName:()=>cy.get('.oxd-autocomplete-text-input > input'),
        selectSupervisorName:()=>cy.get('.oxd-autocomplete-dropdown > :nth-child(1) > span'),
        ...
        licenseExpiryDate:()=>cy.get(':nth-child(2) > .oxd-input-group > :nth-child(2) > .oxd-date-wrapper > .oxd-date-input > .oxd-icon'),
        SelectLicenseExpiryDate:()=>cy.get(':nth-child(30) > .oxd-calendar-date'),
        maritalStatus:()=>cy.get(':nth-child(2) > .oxd-input-group > :nth-child(2) > .oxd-select-wrapper > .oxd-select-text > .oxd-select-text--after > .oxd-icon'),
